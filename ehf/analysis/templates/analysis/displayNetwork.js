    ...
    <div class="row ">\
        <div class="col-md-3">\
            <div class="geneStat">\
                    ...
                    {% for key,value in speciesNumberAbove %}\
                        ...
                        {{ key }}: <span class="geneNumber">{{ value }}</span>\
                        </div>\
                    {% endfor %}\
                ...
                <div class="searchNetwork">\
                    ...
                    <div class="searchInput">\
                        <input type="text" class="form-control" id="searchNet" name="searchNet"\
                               placeholder="Search a gene or pathogen" onkeydown="keyDown(event);">\
                    </div>\
        ...
        <div class="col-md-9">\
            <div class="center-panel">\
                <div class="download"><div id="download" onclick="download(this);">Download png image</div><hr/>\
                <div id="csv" onclick="downloadCSV(this);">Download csv file</div></div>\
                <div id="zoomWrapper">\
                    <table>\
                        <tr>\
                            <td>\
...
$('#networkTip2').qtip({
    content: {
        ...
        text: '<ul><li><b>Filter</b> the graph based on pathogen species, gene number is displayed on the right.</li>\
                <li><b>Mouse over</b> a node\'s label to select a node and its connections, the common genes and specific genes are displayed when a species is selected.</li>\
                ...
                <li><b>Save</b> the graph as an image.</li></ul>'
    },
    position: {
        my: 'top left',
        at: 'bottom right'
